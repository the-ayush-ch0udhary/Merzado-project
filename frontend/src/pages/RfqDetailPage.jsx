    ...
    <div className="container" style={{ padding: '2rem 1.5rem 5rem' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '2rem', alignItems: 'start' }}>
        ...
        <div>
          ...
          {isSupplier && (
            <div className="card" style={{ border: '2px solid var(--primary-200)', backgroundColor: 'var(--primary-light)' }}>
              ...
              {rfq.myQuotation ? (
                <div style={{ background: 'var(--bg-surface)', padding: '1.25rem', borderRadius: 'var(--border-radius)', border: '1px solid var(--border-color)', marginBottom: '1rem' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.75rem' }}>
                    <div>
                      <div style={{ fontSize: '0.8rem', color: 'var(--text-muted)' }}>Your Quoted Total</div>
                  ...
                  {rfq.myQuotation.notes && (
                    <div style={{ fontSize: '0.85rem', color: 'var(--text-main)', background: 'var(--bg-surface-secondary)', padding: '0.75rem', borderRadius: 'var(--border-radius)', border: '1px solid var(--border-color)' }}>
