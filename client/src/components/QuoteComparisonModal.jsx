                  ...
                  <div
                    ...
                    style={{
                      border: quote.status === 'ACCEPTED'
                        ...
                        : '1px solid var(--secondary-200)',
                      backgroundColor: quote.status === 'ACCEPTED' ? '#f0fdf4' : 'white',
                    }}
                  >
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '1rem', marginBottom: '0.75rem' }}>
                      <div>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.25rem' }}>
                          <span style={{ fontWeight: 700, fontSize: '1.05rem', color: 'var(--secondary-900)' }}>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', fontSize: '0.825rem', color: 'var(--secondary-500)' }}>
                      ...
                      <div style={{ textAlign: 'right' }}>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '0.3rem', fontSize: '0.85rem', color: 'var(--secondary-600)', justifyContent: 'flex-end', marginTop: '0.15rem' }}>
                          <Clock size={13} />
                    ...
                    {quote.notes && (
                      <div
                        style={{
                          backgroundColor: quote.status === 'ACCEPTED' ? '#ffffff' : 'var(--secondary-50)',
                          padding: '0.75rem 1rem',
                          borderRadius: 'var(--radius-md)',
                          fontSize: '0.875rem',
                    ...
                    {/* Actions */}
                    <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '0.6rem', marginTop: '0.75rem', paddingTop: '0.75rem', borderTop: '1px solid var(--secondary-100)' }}>
