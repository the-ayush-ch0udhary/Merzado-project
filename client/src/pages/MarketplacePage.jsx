              ...
              <div key={rfq._id} className="card rfq-card">
                  ...
                  <div className="rfq-specs">
                    ...
                    <div className="spec-item">
                      ...
                      <strong style={{ display: 'flex', alignItems: 'center', gap: '0.25rem' }}>
                        <MapPin size={13} style={{ color: 'var(--secondary-400)' }} />
                        {rfq.location}
                      </strong>
                    </div>
                    ...
                    <div className="spec-item">
                      ...
                      <strong
                        style={{
                          color: rfq.isExpired ? 'var(--danger-accent)' : 'var(--secondary-800)',
                          display: 'flex',
                          alignItems: 'center',
                          gap: '0.25rem',
                        }}
                    ...
                    {rfq.buyer && (
                      <div className="spec-item">
                        <span>Posted By:</span>
                        <strong style={{ display: 'flex', alignItems: 'center', gap: '0.25rem' }}>
                          <Building size={13} style={{ color: 'var(--secondary-400)' }} />
                ...
                <div>
                  ...
                  {rfq.myQuotation && (
                    ...
                    >
                      <span>
                        Your Quote: <strong>${Number(rfq.myQuotation.price).toLocaleString()}</strong>
                      </span>
                  ...
                  <div className="rfq-footer">
                    <div style={{ fontSize: '0.85rem', color: 'var(--secondary-500)' }}>
