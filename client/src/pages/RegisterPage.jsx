            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.75rem' }}>
              <div
                ...
                style={{
                  padding: '1rem',
                  borderRadius: 'var(--radius-md)',
                  border: formData.role === 'BUYER' ? '2px solid var(--primary-600)' : '1px solid var(--secondary-300)',
                  backgroundColor: formData.role === 'BUYER' ? 'var(--primary-50)' : 'white',
                  cursor: 'pointer',
                  transition: 'all 0.2s',
                  textAlign: 'center',
                }}
              >
                <Building2
                  size={24}
                  style={{
                    color: formData.role === 'BUYER' ? 'var(--primary-600)' : 'var(--secondary-400)',
                    marginBottom: '0.35rem',
                  }}
                />
                <div style={{ fontWeight: 700, fontSize: '0.95rem', color: 'var(--secondary-900)' }}>
                  Buyer
                </div>
                <div style={{ fontSize: '0.78rem', color: 'var(--secondary-500)', marginTop: '0.15rem' }}>
              ...
              <div
                ...
                style={{
                  padding: '1rem',
                  borderRadius: 'var(--radius-md)',
                  border: formData.role === 'SUPPLIER' ? '2px solid #0284c7' : '1px solid var(--secondary-300)',
                  backgroundColor: formData.role === 'SUPPLIER' ? '#f0f9ff' : 'white',
                  cursor: 'pointer',
                  transition: 'all 0.2s',
                  textAlign: 'center',
                }}
              >
                <Factory
                  size={24}
                  style={{
                    color: formData.role === 'SUPPLIER' ? '#0284c7' : 'var(--secondary-400)',
                    marginBottom: '0.35rem',
                  }}
                />
                <div style={{ fontWeight: 700, fontSize: '0.95rem', color: 'var(--secondary-900)' }}>
